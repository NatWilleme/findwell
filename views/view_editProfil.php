...
<div class="container mt-4">
    ...
    <form action="../controllers/controller_editProfil.php" method="post" enctype='multipart/form-data'>
                        ...
                        <div class="row gutters">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="username" name="username" value="<?php echo $company->name; ?>" placeholder="Votre nom complet">
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
