                        ...
                        <div class="row gutters">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="description" id="description" cols="30" rows="10" maxlength="1999" placeholder="Description de l'entreprise..." required><?php echo $company->description; ?></textarea>
