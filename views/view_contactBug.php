...
<div class="container mt-5 mb-3">
    ...
    <div class="row">
        <div class="text-center col-12 col-lg-7">
            <img class="mb-3" src="images/icons/SignalerUnBug.png" width="350" alt="">
            <form name="formContact" action="index.php?viewToDisplay=displayContactBug" method="post">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="message" class="form-label fw-bold">Bug ou problème à signaler</label>
                    <textarea class="form-control" id="message" name="message" rows="5" required></textarea>
                </div>
                <button class="btn btn-primary" name="sendContactBugMail" type="submit">Envoyer</button>
            </form>
        </div>
        <span class="col-1"></span>
        <div class="col-lg-4 d-none d-lg-block my-auto">
            <img src="images/icons/contactBug.png" width="100%">
        </div>
    </div>
</div>
